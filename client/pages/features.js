...
import Carousel from '../components/Common/Features/Carousel';
import CarouselItem from '../components/Common/Features/CarouselItem';
        ...
        <Carousel className="py-10 my-10 text-white bg-gray-500 lg:py-20">
            <CarouselItem index={0}>
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p>
                        Geoff is one of the founders of NMG, and his current role is internally
                        focused, dealing with NMG’s key executives and leaders in all the businesses
                        of the Group, as well as with shareholders and directors.
                    </p>
                </div>
            </CarouselItem>
            <CarouselItem index={1}>
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p>
                        Mark is one of the founders of NMG, and his current role is internally
                        focused, dealing with NMG’s key executives and leaders in all the businesses
                        of the Group, as well as with shareholders and directors.
                    </p>
                </div>
            ...
            <CarouselItem index={2}>
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p>
                        David is one of the founders of NMG, and his current role is internally
                        focused, dealing with NMG’s key executives and leaders in all the businesses
                        of the Group, as well as with shareholders and directors.
                    </p>
                </div>
            ...
            <CarouselItem index={3}>
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p>
                        Hamish is one of the founders of NMG, and his current role is internally
                        focused, dealing with NMG’s key executives and leaders in all the businesses
                        of the Group, as well as with shareholders and directors.
                    </p>
                </div>
            ...
            <CarouselItem index={4}>
                <div className="flex flex-col items-center justify-center text-center">
                    ...
                    <p>
                        Andrew is one of the founders of NMG, and his current role is internally
                        focused, dealing with NMG’s key executives and leaders in all the businesses
                        of the Group, as well as with shareholders and directors.
                    </p>
                </div>
