...
const Features = () => {
    return (
        <div className="dark:bg-primary bg-white">
            ...
            <Carousel className="py-10 my-10 dark:text-white text-primary px-10 lg:py-20">
                <CarouselItem index={0}>
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p>
                            ...
                            focused, dealing with NMG’s key executives and leaders in all the
                            businesses of the Group, as well as with shareholders and directors.
                        </p>
                    </div>
                </CarouselItem>
